...
/** How many libraries the quick-access row shows before "all" lives in the sidebar. */
const MAX_FREQUENT_LIBRARIES = 7;

/**
 * Quick access to the user's libraries, sitting right under the greeting —
 * the everyday entry point of the library home.
 */
const FrequentLibraries = memo(() => {
  ...
  return (
    <Flexbox gap={12}>
      {isLoading ? (
        ...
        <div className={styles.grid}>
          {data?.slice(0, MAX_FREQUENT_LIBRARIES).map((item) => (
            <button
...
FrequentLibraries.displayName = 'FrequentLibraries';

export default FrequentLibraries;
