export default {
  ...
  'workingDirectory.removeWorktreeAction': 'Delete detached worktree',
  'workingDirectory.removeWorktreeConfirm':
    'Delete detached worktree “{{name}}”? This removes the worktree directory. Git will refuse if it has uncommitted changes.',
  'workingDirectory.removeWorktreeFailed': 'Delete worktree failed',
  'workingDirectory.removeWorktreeSuccess': 'Worktree deleted',
  'workingDirectory.removeWorktreeTitle': 'Delete detached worktree',
