export default {
  ...
  'acceptance.checks.fixed': 'Fixed',
  'acceptance.checks.fixedHint': 'Failed in round {{round}} → fixed in round {{fixedRound}}.',
  ...
  'acceptance.checks.subtitle': '{{count}} check(s) merged across {{rounds}} round(s)',
  ...
  'acceptance.filter.exception': 'Exceptions {{count}}',
  'acceptance.filter.fixed': 'Fixed {{count}}',
  ...
  'acceptance.verdict.exceptions': '{{count}} exception(s) need your judgment',
